...
#define DOMAIN_ID(t)STRUCT_REF(t,2368,int)
#define PHASE_DOMAIN_INDEX(t)STRUCT_REF(t,2372,int)
#define DOMAIN_N_DOMAINS(t)STRUCT_REF(t,2380,int)
#define DOMAIN_SUPER_DOMAIN(t)STRUCT_REF(t,2560,Domain *)
#define DOMAIN_SUB_DOMAIN(t,i)(STRUCT_OFF(t,2384,Domain *)[i])

#define THREAD_STORE(t,nv)(STRUCT_OFF(t,62760,struct store_struct *)[nv])
...
#define THREAD_MATERIAL(t)(STRUCT_REF(THREAD_HEAD(t),145120,Material *))
...
#define P_VF(p)STRUCT_REF(p,2592,real)
#define P_CF(p)STRUCT_REF(p,2600,real)
#define P_VFF(p)STRUCT_REF(p,2608,real)
#define P_DF(p)STRUCT_REF(p,2616,real)
...
#define P_EVAP_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),4680,int)
#define P_DEVOL_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),4684,int)
#define P_OXID_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),4688,int)
#define P_PROD_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),4692,int)
#define P_LAWS(p,in)STRUCT_OFF(P_INJECTION(p),204,int)[in]
...
#define NWC_T(n,c) STRUCT_REF(((char *)NW_CELL(n)+c*472),248,real) 
