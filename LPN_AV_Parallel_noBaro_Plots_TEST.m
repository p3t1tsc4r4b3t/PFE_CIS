...
plot(tspan,c3(15,:),'r-','LineWidth',lw)

plot(tspan,c1(5,:),'k--','LineWidth',lw)
hold on
plot(tspan,c2(5,:),'b--','LineWidth',lw)
plot(tspan,c3(5,:),'r--','LineWidth',lw)
...
%legend('LV Contractility 24%','LV Contractility 46%','LV Contractility 72%','Orientation','vertical','Location','eastoutside');
legend('MAP 24%LVC','MAP 46% LVC','MAP 72%LVC','LVP 24%LVC','LVP 46% LVC','LVP 72%LVC','Orientation','vertical','Location','eastoutside');
...
plot(tspan,c3(6,:),'r-','LineWidth',lw)

plot(tspan,c1(26,:),'k--','LineWidth',lw)
hold on
plot(tspan,c2(26,:),'b--','LineWidth',lw)
plot(tspan,c3(26,:),'r--','LineWidth',lw)
...
% legend('2600rpm','Pulse @6.0s','Pulse @6.1s','Pulse @6.2s','Pulse @6.3s','Pulse @6.4s','Pulse @6.5s','Pulse @6.6s','Pulse @6.7s','Pulse @6.8s','Pulse @6.9s','Orientation','vertical','Location','eastoutside');
legend('AV flow 24%LVC','AV flow 46% LVC','AV flow 72%LVC','LVAD flow 24%LVC','LVAD flow 46% LVC','LVAD flow 72%LVC','Orientation','vertical','Location','eastoutside');
...
saveas(f5,'LVAD_AV_Parallel_test_2600rpm_MAP_QLVAD.fig')
saveas(f5,'LVAD_AV_Parallel_test_2600rpm_MAP_QLVAD.png')
...
%subplot(121)
plot(c1(4,st:fin),c1(5,st:fin),'k','LineWidth',lw*2)
hold on
plot(c2(4,st:fin),c2(5,st:fin),'b','LineWidth',lw*2)
plot(c3(4,st:fin),c3(5,st:fin),'r','LineWidth',lw*2)
...
% %legend('2600rpm','Pulse @6.0s','Pulse @6.1s','Pulse @6.2s','Pulse @6.3s','Pulse @6.4s','Pulse @6.5s','Pulse @6.6s','Pulse @6.7s','Pulse @6.8s','Pulse @6.9s','Orientation','vertical','Location','eastoutside');
legend('LV Contractility 24%','LV Contractility 46%','LV Contractility 72%','Orientation','vertical');
...
saveas(f7,'LVAD_AV_Parallel_test_2600rpm_LV_PV_Loop.fig')
saveas(f7,'LVAD_AV_Parallel_test_2600rpm_LV_PV_Loop.png')
...
%subplot(121)
plot(c1(10,st:fin),c1(11,st:fin),'k','LineWidth',lw*2)
hold on
plot(c2(10,st:fin),c2(11,st:fin),'b','LineWidth',lw*2)
plot(c3(10,st:fin),c3(11,st:fin),'r','LineWidth',lw*2)
...
saveas(f8,'LVAD_AV_Parallel_test_2600rpm_RV_PV_Loop.fig')
saveas(f8,'LVAD_AV_Parallel_test_2600rpm_RV_PV_Loop.png')
...
Mean_QAV(i) = trapz(tspan(st:fin),tdata(6,st:fin))*(60/t_final)*1e-3;
Mean_QVAD(i) = trapz(tspan(st:fin),tdata(26,st:fin))*(60/t_final)*1e-3;
end
